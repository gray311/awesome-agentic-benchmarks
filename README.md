...
The table below covers every full-contract task in the primary registry. “Source incumbent” means a released result exists but no independent exact-contract global SOTA was verified. Suite scores are never copied into individual ARC-AGI-3 or DiG-bench tasks. See [all task contracts and the TTT-Discover/Finch catalogues](docs/all-discovery-tasks.md) for the expanded evidence.

<!-- DISCOVERY_SOTA_TABLE:START -->
| # | Discovery task | Domain | Source | SOTA method / status | Model / backbone | Result | Link |
|---:|---|---|---|---|---|---|---|
| 1 | [Asymmetric matrix multiplication](docs/all-discovery-tasks.md#asymmetric-matrix-multiplication) | ai-foundations | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.44 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 2 | [Batched cumulative sum](docs/all-discovery-tasks.md#batched-cumulative-sum) | ai-foundations | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.104 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 3 | [Cassini gravity-assist trajectory](docs/all-discovery-tasks.md#cassini-trajectory) | astrodynamics | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.820129 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 4 | [Circle packing in a unit square (n=26)](docs/all-discovery-tasks.md#circle-packing-n26) | mathematics-discovery | SimpleTES | AlphaEvolve (live-board tie) | Not disclosed for leaderboard row | 2.6359830849 ↑ (current record) | [evidence](https://einsteinarena.com/problems/circle-packing) |
| 5 | [Circle packing in a unit square (n=32)](docs/all-discovery-tasks.md#circle-packing-n32) | mathematics-discovery | SimpleTES | nanodiscover (EFT) | Qwen3-8B / Finch-8B | 2.939573 ↑ (tie) | [evidence](https://arxiv.org/html/2606.29082) |
| 6 | [Erdős minimum overlap](docs/all-discovery-tasks.md#erdos-minimum-overlap) | mathematics-discovery | SimpleTES | CodexProLong | Not disclosed by leaderboard | 0.38085857 ↓ (current record) | [evidence](https://einsteinarena.com/problems/erdos-min-overlap) |
| 7 | [Galileo gravity-assist trajectory](docs/all-discovery-tasks.md#galileo-trajectory) | astrodynamics | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.795108 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 8 | [Hadamard maximum determinant (n=29)](docs/all-discovery-tasks.md#hadamard-determinant-n29) | mathematics-discovery | SimpleTES | Orrick et al. construction; matched by SimpleTES | Human construction / gpt-oss-120b match | 0.935673 ↑ (tie) | [evidence](https://maths-people.anu.edu.au/~brent/maxdet/order29/) |
| 9 | [LASSO regularization path](docs/all-discovery-tasks.md#lasso-regularization-path) | scientific-algorithms | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 2502.3 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 10 | [Mariner 10 gravity-assist trajectory](docs/all-discovery-tasks.md#mariner-10-trajectory) | astrodynamics | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.326993 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 11 | [Rosetta gravity-assist trajectory](docs/all-discovery-tasks.md#rosetta-trajectory) | astrodynamics | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 1.552968 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 12 | [Scaling-law discovery: domain mix](docs/all-discovery-tasks.md#scaling-law-domain-mix) | ai-foundations | SimpleTES | SLDAgent | Gemini-3-Pro-Preview | 0.993529 ↑ (current record) | [evidence](https://huggingface.co/datasets/pkuHaowei/scaling_law_discovery_results) |
| 13 | [Scaling-law discovery: learning rate and batch size](docs/all-discovery-tasks.md#scaling-law-lr-bsz) | ai-foundations | SimpleTES | SLDAgent | GPT-5 | 0.847918 ↑ (current record) | [evidence](https://huggingface.co/datasets/pkuHaowei/scaling_law_discovery_results) |
| 14 | [Scaling-law discovery: parallel](docs/all-discovery-tasks.md#scaling-law-parallel) | ai-foundations | SimpleTES | Unresolved: SLDAgent vs SimpleTES | Claude Sonnet 4.5 / gpt-oss-120b | Unresolved at published precision (0.999971 vs 1.0) | [evidence](https://huggingface.co/datasets/pkuHaowei/scaling_law_discovery_results) |
| 15 | [Scaling-law discovery: U-shape](docs/all-discovery-tasks.md#scaling-law-u-shape) | ai-foundations | SimpleTES | Aider | GPT-5 | 0.38070320345369735 ↑ (current record) | [evidence](https://huggingface.co/datasets/pkuHaowei/scaling_law_discovery_results) |
| 16 | [Second autocorrelation inequality](docs/all-discovery-tasks.md#second-autocorrelation-inequality) | mathematics-discovery | SimpleTES | ClaudeExplorer | Not disclosed by leaderboard | 0.96359 ↑ (current record) | [evidence](https://einsteinarena.com/problems/second-autocorrelation-inequality) |
| 17 | [Single-cell RNA-seq denoising](docs/all-discovery-tasks.md#single-cell-rna-denoising) | scientific-algorithms | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.74 ↑ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 18 | [Sum-Difference problem](docs/all-discovery-tasks.md#sum-difference-problem) | mathematics-discovery | SimpleTES | MLEvolve | Gemini-3.1-Pro-preview | 1.1901774219 ↑ (current record) | [evidence](https://github.com/InternScience/MLEvolve) |
| 19 | [Superconducting qubit routing](docs/all-discovery-tasks.md#superconducting-qubit-routing) | quantum-compilation | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 15147 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 20 | [Third autocorrelation inequality](docs/all-discovery-tasks.md#third-autocorrelation-inequality) | mathematics-discovery | SimpleTES | Poolish | Not disclosed by leaderboard | 1.45080664 ↓ (current record) | [evidence](https://einsteinarena.com/problems/third-autocorrelation-inequality) |
| 21 | [TriMul GPU kernel](docs/all-discovery-tasks.md#trimul-kernel) | ai-foundations | SimpleTES | K-Search | GPT-5.2 (released GPUMode default) | 1.028 ↓ (current record) | [evidence](https://github.com/caoshiyi/K-Search) |
| 22 | [Voyager 2 gravity-assist trajectory](docs/all-discovery-tasks.md#voyager-2-trajectory) | astrodynamics | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 3.430214 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 23 | [ZAPBench whole-brain forecasting (H=1)](docs/all-discovery-tasks.md#zapbench-h1) | scientific-algorithms | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.0165 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 24 | [ZAPBench whole-brain forecasting (H=4)](docs/all-discovery-tasks.md#zapbench-h4) | scientific-algorithms | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.0211 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 25 | [ZAPBench whole-brain forecasting (H=8)](docs/all-discovery-tasks.md#zapbench-h8) | scientific-algorithms | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.023 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 26 | [ZAPBench whole-brain forecasting (H=16)](docs/all-discovery-tasks.md#zapbench-h16) | scientific-algorithms | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.0251 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 27 | [ZAPBench whole-brain forecasting (H=32)](docs/all-discovery-tasks.md#zapbench-h32) | scientific-algorithms | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 0.0259 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 28 | [Zoned neutral-atom compilation](docs/all-discovery-tasks.md#zoned-neutral-atom-compilation) | quantum-compilation | SimpleTES | SimpleTES (source incumbent; global SOTA unverified) | gpt-oss-120b | 19507.5 ↓ (source incumbent; SOTA unverified) | [evidence](https://arxiv.org/html/2604.19341) |
| 29 | [ARC-AGI-3 ls20 (Agent reasoning)](docs/all-discovery-tasks.md#arc-agi-3-ls20) | interactive-world-discovery | ARC-AGI-3 | No per-task SOTA published (suite aggregate: Tycho) | Not disclosed | No per-task result; suite 100.0 percent | [evidence](https://arcprize.org/leaderboard/community) |
| 30 | [ARC-AGI-3 ft09 (Elementary Logic)](docs/all-discovery-tasks.md#arc-agi-3-ft09) | interactive-world-discovery | ARC-AGI-3 | No per-task SOTA published (suite aggregate: Tycho) | Not disclosed | No per-task result; suite 100.0 percent | [evidence](https://arcprize.org/leaderboard/community) |
| 31 | [ARC-AGI-3 vc33 (Orchestration)](docs/all-discovery-tasks.md#arc-agi-3-vc33) | interactive-world-discovery | ARC-AGI-3 | No per-task SOTA published (suite aggregate: Tycho) | Not disclosed | No per-task result; suite 100.0 percent | [evidence](https://arcprize.org/leaderboard/community) |
| 32 | [DiG-bench P-1 (tier 1)](docs/all-discovery-tasks.md#dig-bench-p-1) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 33 | [DiG-bench P-2 (tier 1)](docs/all-discovery-tasks.md#dig-bench-p-2) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 34 | [DiG-bench P-3 (tier 1)](docs/all-discovery-tasks.md#dig-bench-p-3) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 35 | [DiG-bench P-4 (tier 2)](docs/all-discovery-tasks.md#dig-bench-p-4) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 36 | [DiG-bench P-5 (tier 2)](docs/all-discovery-tasks.md#dig-bench-p-5) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 37 | [DiG-bench P-6 (tier 2)](docs/all-discovery-tasks.md#dig-bench-p-6) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 38 | [DiG-bench P-7 (tier 3)](docs/all-discovery-tasks.md#dig-bench-p-7) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 39 | [DiG-bench P-8 (tier 3)](docs/all-discovery-tasks.md#dig-bench-p-8) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 40 | [DiG-bench P-9 (tier 3)](docs/all-discovery-tasks.md#dig-bench-p-9) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 41 | [DiG-bench P-10 (tier 4)](docs/all-discovery-tasks.md#dig-bench-p-10) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 42 | [DiG-bench P-11 (tier 4)](docs/all-discovery-tasks.md#dig-bench-p-11) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 43 | [DiG-bench P-12 (tier 4)](docs/all-discovery-tasks.md#dig-bench-p-12) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 44 | [DiG-bench P-13 (tier 5)](docs/all-discovery-tasks.md#dig-bench-p-13) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 45 | [DiG-bench P-14 (tier 5)](docs/all-discovery-tasks.md#dig-bench-p-14) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 46 | [DiG-bench P-15 (tier 5)](docs/all-discovery-tasks.md#dig-bench-p-15) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 47 | [DiG-bench P-16 (tier 6)](docs/all-discovery-tasks.md#dig-bench-p-16) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 48 | [DiG-bench P-17 (tier 6)](docs/all-discovery-tasks.md#dig-bench-p-17) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 49 | [DiG-bench P-18 (tier 6)](docs/all-discovery-tasks.md#dig-bench-p-18) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 50 | [DiG-bench P-19 (tier 7)](docs/all-discovery-tasks.md#dig-bench-p-19) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 51 | [DiG-bench P-20 (tier 7)](docs/all-discovery-tasks.md#dig-bench-p-20) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
| 52 | [DiG-bench P-21 (tier 7)](docs/all-discovery-tasks.md#dig-bench-p-21) | interactive-world-discovery | DiG-bench | No per-task SOTA published (suite aggregate: basic harness) | Claude Opus 5 | No per-task result; suite 50 games out of 70 | [evidence](https://arxiv.org/html/2608.12593) |
